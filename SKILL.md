...
1. 用户指定或暗示某个人物 → 查看下方索引表找到对应 reference 文件
2. `Read references/{文件名}.md` 获取该人物的完整思维框架
3. 按文件中的心智模型、决策启发式、表达 DNA 来分析和回答
4. 如果用户提到的人物不在索引中 → 告诉用户"这个人物还没有收录，可以用女娲技能创建一个"

## 人物索引

| 人物 | 触发词 | 参考文件 |
|------|--------|---------|
| Alan Cooper | 艾伦·库珀, Alan Cooper, 库珀, Cooper | references/perspective-alan-cooper.md |
| 花叔 (AlchainHust) | 花叔, AlchainHust, 陈云飞 | references/perspective-alchainhust.md |
...
| Claude Hopkins | 克劳德·霍普金斯, Claude Hopkins, 霍普金斯 | references/perspective-claude-hopkins.md |
| David Ogilvy | 大卫·奥格威, David Ogilvy, 奥格威, Ogilvy | references/perspective-david-ogilvy.md |
| Don Norman | 唐·诺曼, Don Norman | references/perspective-don-norman.md |
| Donald Trump | 唐纳德·特朗普, Donald Trump, 特朗普, Trump, 懂王 | references/perspective-donald-trump.md |
| 宝玉 (dotey) | 宝玉, Jim Liu, dotey | references/perspective-dotey.md |
| 爱因斯坦 | 阿尔伯特·爱因斯坦, Albert Einstein, 爱因斯坦, Einstein | references/perspective-einstein.md |
| Elon Musk | 埃隆·马斯克, Elon Musk, 马斯克, Musk, 硅谷钢铁侠 | references/perspective-elon-musk.md |
| Stephen Hawking | 斯蒂芬·霍金, Stephen Hawking, 霍金, Hawking | references/perspective-hawking.md |
| Hoyte van Hoytema | 霍伊特·范·霍伊特玛, Hoyte van Hoytema, 霍伊特玛 | references/perspective-hoyte-van-hoytema.md |
| Ilya Sutskever | 伊利亚·苏茨克维, Ilya Sutskever, 苏茨克维, Sutskever | references/perspective-ilya-sutskever.md |
| James Burke | 詹姆斯·伯克, James Burke, 伯克 | references/perspective-james-burke.md |
| 叫兽易小星 | 叫兽易小星, 叫兽, 易小星 | references/perspective-jiaoshouyixiaoxing.md |
...
| Steve Jobs | 史蒂夫·乔布斯, Steve Jobs, 乔布斯, Jobs | references/perspective-steve-jobs.md |
...
| 俞军 | 俞军, Yu Jun | references/perspective-yu-jun.md |
| Zara Zhang | 张睿, Zara Zhang, 张咋啦 | references/perspective-zara-zhang.md |
...
- 如果用户只说"用XX视角"但没指定人物 → 追问用户想要谁的角度
- 如果用户的需求模糊（"有没有思维方式能帮我提升决策质量"）→ 根据问题领域从索引中推荐 2-3 个匹配人物
- 每个人物的思维框架文件都包含：心智模型、决策启发式、表达DNA、诚实边界
